function [ c,ceq ] = myConstraint2(X)
global     var_ks_g1_u var_ks_g1_v ...
    ...
    var_ws_g2 var_cp_p2 var_ws_p2 var_ks_p2 l_x0 l_x1 l_p  surf1 surf2 ;
...
if isTrue(patchStatus_cstr) && ~isTrue(trimStatus_cstr)
    for i = 1: num_cstr_patch
        ...
        if cstrMatrix_patch(i,2) == 1  %position constraints
            ...
            ceq(temp+1) = distance(geops_cstr_patch1(i,:),geops_cstr_patch2(i,:))-x2(i)^2;% distance between the points is 2
            temp = temp+1;
        else
            temp = temp;
        end
