...
global  surf3 surf4 var_cp_g3 var_ws_g3  var_cp_p3 var_ws_p3 var_ks_p3 var_cp_g4 var_ws_g4  var_cp_p4 var_ws_p4 var_ks_p4 var_ks_g1_u var_ks_g1_v var_ks_g4_u var_ks_g4_v...
    tLoop1 tLoop2   num_Lp1_cstr   para_cstr_patch3 para_cstr_patch4 var_ks_g2_u var_ks_g2_v var_ks_g3_u var_ks_g3_v...
    num_Lp2_cstr  para_cstr_patch1 para_cstr_patch2   ...
    ...
    var_ws_g2 var_cp_p2 var_ws_p2 var_ks_p2 l_x0 l_x1 l_x2 l_x3 surf1 surf2 ;%this flag is to control the cases of 3D/2D/3_2D
...
if ~isempty(tLoop2)
    ...
    plotTrimCrv3D(srfo_2,tLoop2);
hold on;
end
%%
plotNURBS(srfc_1);hold on;plotParapts(srfc_1,para_cstr_patch1);hold on;plotParapts(srfc_1,para_cstr_patch3);hold on;
plotNURBS(srfc_2,[0.5,0.5,0]);hold on;plotParapts(srfc_2,para_cstr_patch2);hold on;plotParapts(srfc_2,para_cstr_patch3);hold on;
plotNURBS(srfc_3,[0,0.5,0.5]);hold on;plotParapts(srfc_3,para_cstr_patch4);hold on;plotParapts(srfc_3,para_cstr_patch1);hold on;
plotNURBS(srfc_4,[0,0.5,0]);hold on;plotParapts(srfc_4,para_cstr_patch4);hold on;plotParapts(srfc_4,para_cstr_patch2);hold off;
% subplot(2,2,3);
