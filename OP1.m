function [ xx,fval,varscstr] = OP1( basis,over,x,vars )
...
problem = createOptimProblem('fmincon','x0',x0,'objective',objective,'nonlcon',@nonlinear,'options',opts);
gs = GlobalSearch;
